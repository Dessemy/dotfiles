...
font_default = "12pt 'Fira Code'"

c.fonts.completion.entry    = font_default
c.fonts.completion.category = font_default
c.fonts.statusbar           = font_default
c.fonts.keyhint             = font_default
c.fonts.messages.error      = font_default
c.fonts.messages.info       = font_default
c.fonts.messages.warning    = font_default
c.fonts.prompts             = font_default
c.fonts.hints               = "bold 10pt 'Fira Code'"
c.fonts.tabs.selected       = font_default
c.fonts.tabs.unselected     = font_default
