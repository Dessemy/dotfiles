...
hl.bind("SUPER + F",                hl.dsp.exec_cmd("fuzzel"))
hl.bind("SUPER + W",                hl.dsp.exec_cmd("foot -e impala"))
hl.bind("SUPER + C",                hl.dsp.exec_cmd("cliphist list | fuzzel --dmenu | cliphist decode | wl-copy"))
hl.bind("SUPER + B",                hl.dsp.exec_cmd("foot -e bluetui"))
hl.bind("SUPER + SHIFT + V",        hl.dsp.exec_cmd("foot -e wiremix"))
hl.bind("SUPER + SHIFT + W",        hl.dsp.exec_cmd("~/.config/scripts/wallpaper-switcher next"))
hl.bind("SUPER + SHIFT + CTRL + W", hl.dsp.exec_cmd("~/.config/scripts/wallpaper-switcher prev"))
