...
hl.bind("SUPER + I",                hl.dsp.exec_cmd("foot -e btop"))
hl.bind("SUPER + SHIFT + C",        hl.dsp.exec_cmd("foot -e cava"))
hl.bind("SUPER + B",                hl.dsp.exec_cmd("foot -e bluetui"))
hl.bind("SUPER + CTRL + T",         hl.dsp.exec_cmd("foot -e ttyper"))
...
hl.bind("SUPER + C",                hl.dsp.exec_cmd("cliphist list | fuzzel --dmenu --prompt 'Clipboard > ' | cliphist decode | wl-copy"))
