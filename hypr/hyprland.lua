...
hl.bind("SUPER + F3", hl.dsp.exec_cmd("~/.config/scripts/tlp-switcher balanced"))
hl.bind("SUPER + F4", hl.dsp.exec_cmd("~/.config/scripts/tlp-switcher powersave"))
...
hl.bind("SUPER + ALT + C", hl.dsp.exec_cmd("cliphist list | fuzzel --dmenu --prompt 'Clipboard > ' | cliphist decode | wl-copy"))
